            ...
            */
            ...
            setTitle: function(title) {
                ...
                if (title) {
                    ...
                    // set title in shadow to isolate style interference
                    let shadow = $titleEl.get(0).attachShadow({mode: 'open'});
            ...
            setContent: function(content) {
                ...
                if (typeof content === 'string') {
                    // set content in shadow dom to isolate style interference
                    var shadow = $ct.get(0).attachShadow({mode: 'open'});
